...
pygame.init()  # инициализацимодулей пайгейм
# константы
...
ball_width = 150 # ширина игрока
ball_height = 150  # высота игрока
ballx = screen_width // 2 - ball_width // 2
bally = screen_height // 2 - player_2_height // 2  # игрок в центре по высоте
ball_speed_x = ball_direction[0]
ball_speed_y = ball_direction[1]
ball = pygame.Rect((ballx, bally, ball_width,ball_height))  # создаем игрока
...
while game:
    ...
    pygame.draw.rect(screen, WHITE, player_2)  # рисуем игрока
    pygame.draw.rect(screen, WHITE, ball)  # рисуем игрока
